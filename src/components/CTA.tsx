...
export function CTA() {
  ...
  return (
    <section className="py-20 md:py-28 lg:py-32 bg-gradient-to-br from-[#0A1A33] via-[#1A2F4D] to-[#0A1A33] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-10 lg:px-20 text-center relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 text-lg lg:text-xl mb-12 max-w-2xl mx-auto leading-relaxed">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="bg-[#C9A24A] text-white px-12 py-6 rounded-xl inline-flex items-center gap-3 shadow-2xl hover:bg-[#B8923D] transition-all duration-300 cursor-pointer"
          >
            Contact Our Experts
            <ArrowRight size={22} />
          </motion.button>
